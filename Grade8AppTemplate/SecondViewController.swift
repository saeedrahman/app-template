/*
 ...
 All @IBOutlets should be listed at the top of the class file, then
 all variables, and then all functions (including @IBActions which are
 essentially functions)
 
 Please include details comments on your code to both demonstrate
 understanding, and which serve you as a reminder as to what your code
 actually does.
